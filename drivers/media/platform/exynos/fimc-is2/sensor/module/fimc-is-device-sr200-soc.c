...
#if defined(CONFIG_CAMERA_XCOVER3VELTE) /* F2.4 Xcover3veLTE */
...
static struct fimc_is_sensor_cfg settle_sr200[] = {
	FIMC_IS_SENSOR_CFG(1600, 1200, 15, 4, 0),
	FIMC_IS_SENSOR_CFG(1280, 960, 15, 4, 1),
	FIMC_IS_SENSOR_CFG(800, 600, 30, 4, 2),
	FIMC_IS_SENSOR_CFG(640, 480, 30, 4, 3),
	FIMC_IS_SENSOR_CFG(640, 480, 24, 5, 4),
	FIMC_IS_SENSOR_CFG(352, 288, 30, 4, 5),
	FIMC_IS_SENSOR_CFG(352, 288, 24, 5, 6),
